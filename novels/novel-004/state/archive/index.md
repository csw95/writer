...
## 当前归档状态
- **last_archived_chapter**: 15（场景因果链早段）
...
|------|----------|----------|----------|------|
| `chapters-0001-0050.md` | Ch1-Ch15（Ch15 为早段场景因果链） | 场景因果链、阶段摘要、人物/关系、Fact/LOOP 变化 | 2026-07-01 | 因 scene_causal_chains 活跃窗口超过验证阈值而归档；Ch18 后追加 Ch15 早段场景链以维持活跃窗口 |
