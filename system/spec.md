...
- 每章必须区分正文发布语域和系统接力语域：正文区写给读者，元数据、场景记录、Fact/Loop 记录和补充说明写给接力系统
...
```text
Ch19 / Ch21 / Chapter 20 / Scene 1 / FACT-001 / LOOP-001 / REL-MAIN-001
STATE 2 / STATE_6 / chapter_plan / canon_fact_plan / pending_action / run_lock
