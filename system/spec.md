...
- 禁止在 premise / world / characters / canon / volume / arc 未补齐前启动批量自动化
- 禁止第一章未通过开篇审阅就进入每日 3-10 章生产
...
STATE 1: 结构生成 → 按篇幅档位生成 long_term_arc / volume / arc
...
1. **bible（故事圣经）**: 一句话卖点、分类定位、类型承诺、读者期待、黄金三章目标、禁止偏离项
2. **world（世界观）**: 世界规则、力量体系（必须可计算）、社会结构、资源体系、代价体系、时间历法、地图地点、移动成本、禁用补丁
3. **characters（角色系统）**: 主角 Want/Need/Lie/Wound、核心配角、敌对势力、反派主动计划、关系网、人物分级、登场前最小画像、阶段命运方向、新增人物规则
4. **canon（事实库）**: 幕后事实、历史关键事实、暗线真相、身份秘密、能力/物品/制度真相、公开版本、知情状态、显露窗口、禁止改写项
5. **story_structure（故事结构）**: 长期主线（按 length_tier）、冲突升级路线、节奏审稿节点、主要人物长期命运线、关系线主次规划、Volume（按篇幅档位）、Arc（按篇幅档位）、章节目标
6. **state（核心运行状态）**: 当前剧情阶段、章节摘要、时间线、地点、主角状态（战力/情绪/资源）、敌对势力状态、事实显露状态、未解决冲突、质量风险、错误修复台账、下一章目标
7. **open_loops（伏笔系统）**: 未解决剧情线索、关联事实、计划回收章节、最晚回收章节、当前状态
8. **runs（批次日志）**: 每日或每批章节生成记录、质量风险、下一批起点
...
2. 主角身份、处境、当前目标清晰。
3. 分类定位和类型承诺有明确可感知信号。
4. 金手指或特殊优势露出一角，但不能无代价完全解决问题。
5. 世界观不得百科式开场；必要说明必须服务当前场景，并通过冲突、压迫、选择、代价或异常逐步显露。
6. 主角画像、压迫关系、第一阶段命运方向必须可感知。
7. 章末钩子直接拉动第二章。
